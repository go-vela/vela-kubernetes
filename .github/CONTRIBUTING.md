...
```bash
# Clone the project
git clone git@github.com:go-vela/vela-kubernetes.git $HOME/go-vela/vela-kubernetes
```
...
cd $HOME/go-vela/vela-kubernetes
```
...
git remote add fork https://github.com/your_fork/vela-kubernetes
```
